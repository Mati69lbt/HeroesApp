  ...
  !(function () {
    ...
    function g(e) {
      ...
      var n = e.window,
        ...
        r = t.history;
      function a() {
        var e = x(t.location.hash.substr(1)),
          n = e.pathname,
          a = void 0 === n ? "/" : n,
          l = e.search,
          o = void 0 === l ? "" : l,
      ...
      function _(e, n, t) {
        return !g.length || (g.call({ action: e, location: n, retry: t }), !1);
      }
      function N(e) {
        i = e;
        var n = a();
        (c = n[0]), (f = n[1]), d.call({ action: i, location: f });
      }
      function P(e) {
        r.go(e);
      }
      null == c && ((c = 0), r.replaceState(p({}, r.state, { idx: c }), ""));
      var j = {
        get action() {
          return i;
        },
        ...
        block: function (e) {
          var n = g.push(e);
          return (
            1 === g.length && t.addEventListener(m, y),
            function () {
              n(), g.length || t.removeEventListener(m, y);
            }
          );
        },
      };
    ...
    function N(e, n, t) {
      void 0 === t && (t = "/");
      var r = R(("string" === typeof n ? x(n) : n).pathname || "/", t);
      if (null == r) return null;
      var a = P(e);
      !(function (e) {
        e.sort(function (e, n) {
      ...
      for (var l = null, o = 0; null == l && o < a.length; ++o) l = O(a[o], r);
      return l;
    }
    function P(e, n, t, r) {
      return (
        ...
        e.forEach(function (e, a) {
          ...
          e.children &&
            e.children.length > 0 &&
            (!0 === e.index && _(!1), P(e.children, n, i, o)),
            (null != e.path || e.index) &&
              n.push({ path: o, score: T(o, e.index), routesMeta: i });
        }),
        n
      );
    }
      ...
      var u = (function (e, n) {
        ...
        var t = "string" === typeof e ? x(e) : e,
          ...
          u = r
            ...
            : n;
        return { pathname: u, search: I(l), hash: A(i) };
      })(a, r);
      return (
        l &&
          "/" !== l &&
    ...
    function $() {
      return B() || _(!1), (0, e.useContext)(C).location;
    }
    function W() {
      B() || _(!1);
      var n = (0, e.useContext)(S),
        t = n.basename,
        r = n.navigator,
    ...
    function V(n) {
      var t = (0, e.useContext)(E).matches,
        r = $().pathname,
        a = JSON.stringify(
          t.map(function (e) {
            return e.pathnameBase;
    ...
    function H(n, t) {
      return (
        ...
        null == n
          ...
          : n.reduceRight(function (r, a, l) {
              return (0,
              e.createElement)(E.Provider, { children: void 0 !== a.route.element ? a.route.element : r, value: { outlet: r, matches: t.concat(n.slice(0, l + 1)) } });
            }, null)
      );
    }
    function Q(n) {
      ...
      var m = o,
        ...
        z = (0, e.useMemo)(
          function () {
            ...
            return null == e
              ? null
              : { pathname: e, search: b, hash: w, state: N, key: j };
          },
          [p, g, b, w, N, j]
        );
      return null == z
    ...
    function Y(n) {
      ...
      return (function (n, t) {
        ...
        var f = r.pathname || "/",
          d = N(n, { pathname: "/" === i ? f : f.slice(i.length) || "/" });
        return H(
          d &&
            d.map(function (e) {
              return Object.assign({}, e, {
        ...
        e.Children.forEach(n, function (n) {
          if ((0, e.isValidElement)(n))
            if (n.type !== e.Fragment) {
              ...
              n.props.children && (r.children = G(n.props.children)), t.push(r);
            } else t.push.apply(t, G(n.props.children));
        }),
        t
      );
    }
    ...
    function ne(n) {
      var t = n.basename,
        ...
        l = n.window,
        o = (0, e.useRef)();
      null == o.current && (o.current = g({ window: l }));
      var i = o.current,
        u = a((0, e.useState)({ action: i.action, location: i.location }), 2),
        s = u[0],
        c = u[1];
    ...
    var re = (0, e.forwardRef)(function (n, t) {
      var r = n["aria-current"],
        a = void 0 === r ? "page" : r,
        l = n.caseSensitive,
        o = void 0 !== l && l,
      ...
      var x = "function" === typeof f ? f({ isActive: k }) : f;
      return (0,
      e.createElement)(te, J({}, h, { "aria-current": w, className: b, ref: t, style: x, to: d }), "function" === typeof p ? p({ isActive: k }) : p);
    });
    var ae = t(184),
      le = function () {
        var n = a((0, e.useState)(""), 2),
        ...
        return (0, ae.jsxs)("div", {
          ...
          children: [
            (0, ae.jsx)("div", {
              className: "title",
              children: (0, ae.jsxs)("h1", {
                children: [
                  (0, ae.jsx)("span", { className: "span", children: "what " }),
                  (0, ae.jsx)("span", { className: "span", children: "is " }),
                  (0, ae.jsx)("span", { className: "span", children: "your " }),
                  (0, ae.jsx)("span", { className: "span", children: "name?" }),
                ],
              }),
            }),
            (0, ae.jsxs)("form", {
            ...
            children: [
              ...
              (0, ae.jsx)("div", {
                ...
                children: (0, ae.jsxs)("div", {
                  className: "card-body",
                  children: [
                    (0, ae.jsx)("h5", { className: "card-title", children: t }),
                    (0, ae.jsx)("p", {
                      className: "card-text",
                      children: (0, ae.jsx)("small", {
                        className: "text-muted",
                        children: r,
                      }),
                    }),
                    r !== l &&
                      (0, ae.jsx)("p", { className: "card-text", children: l }),
                    (0, ae.jsx)("p", { className: "card-text", children: a }),
                    (0, ae.jsx)(te, {
                      to: "/hero/".concat(n),
                      children: "M\xe1s...",
                    }),
      ...
      fe = function () {
        return (0, ae.jsxs)("div", {
          children: [
            (0, ae.jsx)(ce, { publisher: "Marvel Comics" }),
            (0, ae.jsx)("hr", {}),
          ],
        });
      },
      de = function () {
        var n = (function () {
            var n = (0, e.useContext)(E).matches,
              t = n[n.length - 1];
            return t ? t.params : {};
          })().heroeId,
          t = W(),
          ...
          children: [
            ...
            (0, ae.jsxs)("div", {
              ...
              children: [
                ...
                (0, ae.jsxs)("ul", {
                  ...
                  children: [
                    ...
                    (0, ae.jsxs)("li", {
                      className: "list-group-item",
                      children: [
                        (0, ae.jsx)("b", { children: "First appearance:" }),
                        " ",
                        i,
                      ],
                    }),
                ...
                (0, ae.jsx)("h5", { children: "Chararters" }),
                (0, ae.jsxs)("p", { children: [" ", u] }),
                (0, ae.jsx)("button", {
                  className: "btn btn-outline-info",
                  onClick: function () {
                    return t(-1);
      ...
      pe = function () {
        return (0, ae.jsxs)("div", {
          children: [
            (0, ae.jsx)(ce, { publisher: "DC Comics" }),
            (0, ae.jsx)("hr", {}),
          ],
        });
      },
      ...
      ve = function () {
        var n = $(),
          t = he.parse(n.search).q,
          r = void 0 === t ? "" : t,
          l = W(),
          o = a(me({ searchText: r }), 2),
          i = o[0],
          s = o[1],
          c = i.searchText,
          f = (0, e.useMemo)(
        ...
        return (0, ae.jsx)("div", {
          children: (0, ae.jsxs)("div", {
            ...
            children: [
              ...
              f.map(function (e) {
                return (0,
                ae.jsx)("div", { className: "centro", style: { display: "flex", alignItems: "center", flexDirection: "column" }, children: (0, ae.jsx)(se, u(u({}, e), {}, { style: !0 }), e.id) }, e.id);
              }),
            ],
          }),
        });
      ...
      ye = function (e) {
        return (0, ae.jsxs)(ae.Fragment, {
          children: [
            ...
            (0, ae.jsx)("div", {
              className: "container mt-2",
              children: (0, ae.jsxs)(Y, {
                children: [
                  (0, ae.jsx)(q, { path: "/", element: (0, ae.jsx)(ge, {}) }),
                  (0, ae.jsx)(q, {
                    path: "/marvel",
                    element: (0, ae.jsx)(fe, {}),
                  }),
                  ...
                  (0, ae.jsx)(q, { path: "/dc", element: (0, ae.jsx)(pe, {}) }),
                  (0, ae.jsx)(q, {
                    path: "/search",
                    element: (0, ae.jsx)(ve, {}),
                  }),
      ...
      be = function (n) {
        ...
        return (
          localStorage.setItem("lastPath", o + i),
          r.logged ? t : (0, ae.jsx)(Q, { to: "/login" })
        );
      },
      ke = function (n) {
        var t = n.children;
      ...
      we = function () {
        return (0, ae.jsx)(ne, {
          children: (0, ae.jsx)(e.StrictMode, {
            children: (0, ae.jsx)("div", {
              children: (0, ae.jsxs)(Y, {
                children: [
                  (0, ae.jsx)(q, {
                    path: "/login",
                    element: (0, ae.jsx)(ke, { children: (0, ae.jsx)(le, {}) }),
                  }),
                  (0, ae.jsx)(q, {
                    path: "/*",
                    element: (0, ae.jsx)(be, { children: (0, ae.jsx)(ye, {}) }),
                  }),
                ],
              }),
            }),
      ...
      Se = function () {
        ...
        return (
          ...
          (0, ae.jsxs)(l.Provider, {
            value: { user: t, dispatch: r },
            children: [(0, ae.jsx)(we, {}), ";"],
          })
        );
      };
    n.createRoot(document.getElementById("root")).render((0, ae.jsx)(Se, {}));
  })();
})();
